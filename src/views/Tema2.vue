...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    SlyderF.mb-5.mt-5(columnas="col-lg-5 col-xl-4")
      .tarjeta-avatar
        ...
        .tarjeta.tarjeta--amarilla-1.p-4
          ...
          p.text-center.text-small Citando nuevamente a Arroyo Guardeño, D. Gayoso Martínez, V. & Hernández Encinas, L. (2020), “en España, por ejemplo, en solo un año, entre 2018 y 2019, los ciberdelitos denunciados representaron un 10% del total de denuncias por algún tipo de delito, y en este mismo periodo se tuvo un aumento del 35% de los casos reportados” (p.11).

      .tarjeta-avatar
        img(src='@/assets/curso/temas/Tema2/carrusel2.svg' alt='AvatarTop')
        .tarjeta.tarjeta--amarilla-1.p-4
          h4.text-center.mt-5 En Colombia
          p.text-center.text-small Según cifras del Centro Cibernético Policial MinTIC (2021), durante el año 2021 los delitos cibernéticos en Colombia ascendieron a 33.465, lo que significa un aumento de 17 % en comparación con 2020, cuando fueron 28.524 casos. Además, se recibieron 1.558 denuncias y se efectuaron 49 capturas”, revelaron las autoridades.
      ...
      .tarjeta-avatar
        ...
        .tarjeta.tarjeta--amarilla-1.p-4
          ...
          p.text-center.text-small El objetivo general de esta política es que los colombianos y las empresas conozcan e identifiquen los riesgos a los que están expuestos en el entorno digital y aprendan como protegerse, prevenir y reaccionar ante los delitos y ataques cibernéticos.
          p.text-center.text-small Esta labor a nivel institucional requiere un arduo trabajo e inversión conjuntas entre el estado y la empresa privada, labor que tiene un alto componente educativo, el cual exige adoptar una cultura de seguridad digital en el país. 
    ...
    .row.justify-content-around.align-items-center.mb-5.mt-5
      ...
      #t_2_5.titulo-segundo.color-acento-contenido.mt-2
        h2 2.5	Técnicas de diagnóstico




      .row.justify-content-around.align-items-center.mb-5
        .row.justify-content-around.align-items-center.textoeditado
          .col-lg-5.mb-6
            p En este ítem se listan algunas recomendaciones y procedimientos para identificar el estado del sistema de información digital y de los equipos.
            p Para iniciar, es necesario recordar que una vulnerabilidad es un punto débil del sistema, desde el cual un tercero o una persona malintencionada puede acceder al sistema de información.  Una forma útil para diagnosticar la seguridad de este, consiste en ubicarse en el lugar de quien quiere perjudicar el sistema, e intentar acceder a afectar algún elemento.
          .col-lg-6
            figure
